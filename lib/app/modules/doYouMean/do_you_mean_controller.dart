  ...
  Future<void> findGames(String gameName) async {
    List response = await Dio()
        .post("https://api.igdb.com/v4/games/",
            data:
                'fields name,cover.image_id,summary,first_release_date,genres.name,platforms.name,total_rating, involved_companies.company.name,involved_companies.developer; search "zelda"; limit 30;',
